                    ...
                    {this.props.articles.length > 0?this.props.articles.map((article,i) =>
                      <div className="item" key={i}>
                        ...
                        <div className="content">
                          <a href={article.web_url} className="header" target="_blank" rel="noopener noreferrer">{article.headline.main}</a>
                            <div className="meta">
                              <span className="cinema">Published</span>
                            </div>
                          ...
                          <div className="extra">
                              ...
                              <a href={article.web_url} className="ui inverted right floated primary button" target="_blank" rel="noopener noreferrer">Link</a>
                              </form>
                            </div>
                          </div>
                        </div>
