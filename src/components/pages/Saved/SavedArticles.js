        ...
        return ( 
            <div className="ui segment">
                ...
                <div className="item" key={article._id}>
                    ...
                    <a href={article.web_url} className="header" target="_blank" rel="noopener noreferrer">{article.headline}</a>
                        <div className="meta">
                    ...
                    <div className="extra">
                        ...
                        <a href={article.link} className="ui inverted right floated primary button" target="_blank" rel="noopener noreferrer">Link</a>
                        </form>
                        </div>
                    </div>
                    </div>
